...
const urdu = {
    ...
    bill:'بل',
    headerH1:'قومی رہنما:',
    headerSpan:'عزت مآب ایڈوکیٹ پرکاش اور بالا صاحب امبیڈکر',
    headerH12:'قومی رہنما:',
    headerSpan2:'ونچیت بہوجن مسلم اگھاڑی',
    voiceH1:'عوام کی آواز',
    voiceBtn:'زیادہ جانو',
    aboutH1:'ہمارے بارے میں',
    aboutDetails:'ونچیت بہوجن مسلم اگھاڑی ایک ہندوستانی سیاسی جماعت ہے جس کی بنیاد پرکاش امبیڈکر نے 20 مارچ 2018 کو رکھی تھی۔',
    aboutBtn:'زیادہ جانو',
    DonateIndia: 'ہندوستانی عطیات',
    DonateInternational: 'بین الاقوامی عطیات',
    donateP:'اس مقصد میں مدد کے لیے براہ کرم عطیہ کرنے کے لیے اوپر دیا گیا QR کوڈ اسکین کریں۔',
    donatePInternational: 'بین الاقوامی عطیات کے لیے براہ کرم مندرجہ بالا تفصیلات پر عمل کریں۔',
    gallery:'گیلری',
    galleryP: 'ہم کیا کرتے ہیں اس کی ایک جھلک',
    contact: 'ونچیت بہوجن مسلم اگھاڑی',
    contactNumber: '022 2541122 9899585606/932228645',
    contactH1: 'ونچیت بہوجن مسلم اگھاڑی',
    contactOffice: 'مرکزی دفتر: اویڈکر بھون، بھوکولداس پاستا روڈ، دادر، ممبئی 400 028',
    contactMumbai: 'ممبئی سٹی آفس: دکان c. 04 رتلام والا مشن ساکلی روڈ سی۔ 3. بائیکلہ (W)، ممبئی-4OO COL',
    contactSuburban: 'ممبئی مضافاتی دفتر: آفس K10، اجمیری مسجد کے سامنے، انیس کمپا ادھیری گھاٹ کوپر لنک روڈ، ساکیناکا، ممبئی - 400 072',
